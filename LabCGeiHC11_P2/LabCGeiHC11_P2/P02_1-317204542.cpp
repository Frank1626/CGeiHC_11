...
void CrearLetrasyFiguras()
{
	...
	GLfloat vertices_letras[] = {	
			//X			Y			Z			R		G		B
			//Triangulo A1
			-0.7f,     0.0f,       -1.5f,      1.0f,   0.0f,   0.0f,
			-0.7f,    -0.3f,       -1.5f,      1.0f,   0.0f,   0.0f,
			-0.6f,    -0.3f,       -1.5f,      1.0f,   0.0f,   0.0f,
			//Triangulo A2
			-0.7f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.6f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.6f,-0.3f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A3
			-0.4f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.4f,-0.3f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A4
			-0.3f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,-0.3f,-1.5f,1.0f,0.0f,0.0f,
			-0.4f,-0.3f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A5
			-0.7f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.7f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A6
			-0.7f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,0.0f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A7
			-0.7f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.6f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.7f,0.2f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A8
			-0.6f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.7f,0.2f,-1.5f,1.0f,0.0f,0.0f,
			-0.5f,0.4f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A9
			-0.6f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.5f,0.3f,-1.5f,1.0f,0.0f,0.0f,
			-0.5f,0.4f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A10
			-0.5f,0.3f,-1.5f,1.0f,0.0f,0.0f,
			-0.5f,0.4f,-1.5f,1.0f,0.0f,0.0f,
			-0.4f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A11
			-0.4f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,0.2f,-1.5f,1.0f,0.0f,0.0f,
			-0.5f,0.4f,-1.5f,1.0f,0.0f,0.0f,
			//Triangulo A12
			-0.4f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			-0.3f,0.1f,-1.5f,1.0f,0.0f,0.0f,
			...
			//Triangulo F1
		-0.1f,-0.3f,-1.5f,0.0f,1.0f,0.0f,
		-0.2f,-0.3f,-1.5f,0.0f,1.0f,0.0f,
		-0.2f,0.4f,-1.5f,0.0f,1.0f,0.0f,
		//Triangulo F2
		-0.1f,-0.3f,-1.5f,0.0f,1.0f,0.0f,
		-0.2f,0.4f,-1.5f,0.0f,1.0f,0.0f,
		-0.1f,0.4f,-1.5f,0.0f,1.0f,0.0f,
		//Triangulo F3
		-0.1f,0.0f,-1.5f,0.0f,1.0f,0.0f,
		-0.1f,0.1f,-1.5f,0.0f,1.0f,0.0f,
		0.1f,0.1f,-1.5f,0.0f,1.0f,0.0f,
		//Triangulo F4
		-0.1f,0.0f,-1.5f,0.0f,1.0f,0.0f,
		0.1f,0.0f,-1.5f,0.0f,1.0f,0.0f,
		...
		//Triangulo H1
		0.3f,-0.3f,-1.5f,0.0f,0.0f,1.0f,
		0.3f,0.4f,-1.5f,0.0f,0.0f,1.0f,
		0.4f,0.4f,-1.5f,0.0f,0.0f,1.0f,
		//Triangulo H2
		0.3f, -0.3f, -1.5f,0.0f,0.0f,1.0f,
		0.4f, -0.3f, -1.5f,0.0f,0.0f,1.0f,
		0.4f, 0.4f, -1.5f,0.0f,0.0f,1.0f,
		//Triangulo H3
		0.4f,0.0f,-1.5f,0.0f,0.0f,1.0f,
		0.6f,0.0f,-1.5f,0.0f,0.0f,1.0f,
		0.6f,0.1f,-1.5f,0.0f,0.0f,1.0f,
		//Triangulo H4
		0.4f, 0.0f, -1.5f,0.0f,0.0f,1.0f,
		0.4f, 0.1f, -1.5f,0.0f,0.0f,1.0f,
		0.6f, 0.1f, -1.5f,0.0f,0.0f,1.0f,
		//Triangulo H5
		0.6f, -0.3f, -1.5f,0.0f,0.0f,1.0f,
		0.7f, -0.3f, -1.5f,0.0f,0.0f,1.0f,
		0.6f, 0.4f, -1.5f,0.0f,0.0f,1.0f,
		//Triangulo H6
		0.7f, -0.3f, -1.5f,0.0f,0.0f,1.0f,
		0.6f, 0.4f, -1.5f,0.0f,0.0f,1.0f,
		0.7f, 0.4f, -1.5f,0.0f,0.0f,1.0f,
