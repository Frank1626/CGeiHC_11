...
int main()
{
	...
	dadoAnimalTexture = Texture("Textures/dadoAnimalesP6.tga");
	dadoAnimalTexture.LoadTextureA();
	...
	DadoAnimal_M = Model();
	DadoAnimal_M.LoadModel("Models/DadoP6.obj");
