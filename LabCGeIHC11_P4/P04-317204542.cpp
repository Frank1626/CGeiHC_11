...
int main()
{
	...
	*/
	camera = Camera(glm::vec3(-10.0f, 8.0f, 20.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.2f, 0.2f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(12.0f, 8.0f, 6.0f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(8.0f, 2.0f, 1.0f));
		...
		// Base 
		model = glm::translate(model, glm::vec3(0.0f, -5.0f, 0.0f));
		model = glm::scale(model, glm::vec3(14.0f, 4.0f, 6.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::translate(model, glm::vec3(-6.5f, -7.0f, 3.0f));
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.5f, 0.0f));  //La alejamos un poco mas de la piramide y esfera (cuando la articulacion tiene geometria)
		...
		modelaux = modelaux2;
		model = modelaux;      //Regreso a cabina descartando rotacion
		model = glm::translate(model, glm::vec3(-6.5f, -7.0f, -3.0f));
		...
		*/
		...
		//Articulacion 2 Brazo1_P1-Brazo1_P2
		...
		//Articulacion 4 Brazo1_P1-Brazo1_P2
		model = glm::translate(model, glm::vec3(5.0f, 0.0f, 0.0f));
		...
		//Articulacion 6 Brazo1_P1-Brazo1_P2
		model = glm::translate(model, glm::vec3(-5.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		...
		//Articulacion 9 oreja
		model = glm::translate(model, glm::vec3(0.5f, 0.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9() - 180), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(0.15f, 0.15f, 0.15f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[1]->RenderMeshGeometry(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular

		model = modelaux3;

		//Articulacion 10 oreja
		model = glm::translate(model, glm::vec3(-0.5f, 0.5f, 0.0f));
